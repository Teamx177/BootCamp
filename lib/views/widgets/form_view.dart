...
//ilan türü
final List<String> itemtype = [ 'Çalışma Şekli:','Uzaktan','İşyerinde', 'Hibrit' ];
// konum
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                decoration: const InputDecoration(
                                  border: InputBorder.none,
                                  hintText: 'İş İlanınızın Açıklamasını Giriniz',
                                  hintStyle: TextStyle(
                                    fontSize: 16,
                                    color: Colors.black,
                                  ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                decoration: const InputDecoration(
                                  border: InputBorder.none,
                                  hintText: 'İş İlanınızın Gerekliliklerini Giriniz:',
                                  hintStyle: TextStyle(
                                    fontSize: 16,
                                    color: Colors.black,
                                  ),
