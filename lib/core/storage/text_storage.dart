...
class ErrorTexts {
  ...
  static String tooManyRequests = 'Çok fazla istek gönderildi. Daha sonra tekrar deneyiniz';
  ...
  static String credentialAlreadyUse = 'Bu telefon numarası zaten kullanılıyor.';
  static String credentialNotValid = 'Lütfen geçerli bir telefon numarası giriniz.';
  static String credentialAlreadyLinked = 'Bu telefon numarası zaten başka bir hesaba bağlı.';
